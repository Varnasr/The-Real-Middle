...
import { TrendingUp, Users, DollarSign, AlertCircle, BookOpen, Heart, MapPin } from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div className="card">
              ...
              {currentFeature === 'poverty-trap' && (
                <>
                  <h3 className="text-2xl font-semibold text-white mb-6 text-center">Breaking the Poverty Cycle</h3>
